...
import joblib
import pickle
# --- TensorFlow ELIMINADO para Render ---
# import tensorflow as tf

app = Flask(__name__)

# --- Cargar modelos (ligeros) SOLO UNA VEZ ---
...
def predict():
    ...
    tabla_resultados = [
        ...
        # {"modelo": "Deep Learning", "pred": pred_dl, "probs": "Desactivado"},
    ]

    predicciones = [pred_rf, pred_xgb, pred_mlp, pred_svm, pred_knn]
